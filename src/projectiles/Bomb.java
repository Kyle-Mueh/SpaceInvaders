 ...
 * @author Kyle
 *
 *	changed a method as was requested in piazza, however this method still had issues and a lonf time of debugging didn't find it.
 *	
 */
...
//	}
	...
	public boolean blowUp(BoundingRing r) {
		blowUp=(hit(r) || explosion.collide(r));
		return blowUp;
	}
	@Override
